! function(t) {
    ...
    function l(i, a, l) {
        var r = i.length;
        r ? (a.shuffle && (i = s(i)), a.reverse && (i = i.toArray().reverse()), t.each(i, function(i, s) {
            function c() {
                e(a.effect) ? u.css("visibility", "visible") : n(a.effect) && u.css("visibility", "hidden"), !(r -= 1) && l && l()
            }
            var u = t(s),
    ...
    var r = function(i, s) {
        var o = this,
            r = t(i);
        o.init = function() {
            o.$texts = r.find(s.selector), o.$texts.length || (o.$texts = t('<ul class="texts"><li>' + r.html() + "</li></ul>"), r.html(o.$texts)), o.$texts.hide(), o.$current = t("<span>").html(o.$texts.find(":first-child").html()).prependTo(r), e(s.in.effect) ? o.$current.css("visibility", "hidden") : n(s.out.effect) && o.$current.css("visibility", "visible"), o.setOptions(s), o.timeoutRun = null, setTimeout(function() {
            ...
            i = i || 0;
            var c, u = o.$texts.find(":nth-child(" + ((i || 0) + 1) + ")"),
                f = t.extend(!0, {}, o.options, u.length ? a(u[0]) : {});
            u.addClass("current"), o.triggerEvent("inAnimationBegin"), r.attr("data-active", u.data("id")), o.$current.html(u.html()).lettering("words"), "char" == o.options.type && o.$current.find('[class^="word"]').css({
                ...
                t(this).lettering()
            }), c = o.$current.find('[class^="' + o.options.type + '"]').css("display", "inline-block"), e(f.in.effect) ? c.css("visibility", "hidden") : n(f.in.effect) && c.css("visibility", "visible"), o.currentIndex = i, l(c, f.in, function() {
                o.triggerEvent("inAnimationEnd"), f.in.callback && f.in.callback(), s && s(o)
            })
        }, o.out = function(e) {
            ...
            o.triggerEvent("outAnimationBegin"), l(i, s.out, function() {
                n.removeClass("current"), o.triggerEvent("outAnimationEnd"), r.removeAttr("data-active"), s.out.callback && s.out.callback(), e && e(o)
            })
        }, o.start = function(t) {
            setTimeout(function() {
