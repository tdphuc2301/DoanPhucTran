...
@section('content')
    <div class="row" id="object-category">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body ">
                    ...
                    <div id="datatable">
                        @include('Admin.PaymentMethod.datatable', [
        ...
        @include('Admin.PaymentMethod.create-model')
    </div>
@endsection
@section('script')
    <script>
        var apiGetList = '{{ route('admin.payment_method.get_list') }}';
        var apiCreate = '{{ route('admin.payment_method.create') }}';
        var apiGetItem = '{{ route('admin.payment_method.get_item') }}';
        var apiChangeStatus = '{{ route('admin.payment_method.change_status') }}';
