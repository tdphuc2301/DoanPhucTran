...
@section('content')
    <div class="row" id="object-category">
        ...
        @include('Admin.Ram.create-model')
    </div>
@endsection
@section('script')
    <script>
        var apiGetList = '{{ route('admin.ram.get_list') }}';
        var apiCreate = '{{ route('admin.ram.create') }}';
        var apiGetItem = '{{ route('admin.ram.get_category') }}';
        var apiChangeStatus = '{{ route('admin.ram.change_status') }}';
