...
@section('content')
    <div class="row" id="object-promotion">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body ">
                    ...
                    <div id="datatable">
                        @include('Admin.Promotion.datatable', [
        ...
        @include('Admin.Promotion.create-model')
    </div>
@endsection
@section('script')
    <script>
        var apiGetList = '{{ route('admin.promotion.get_list') }}';
        var apiCreate = '{{ route('admin.promotion.create') }}';
        var apiGetItem = '{{ route('admin.promotion.get_promotion') }}';
        var apiChangeStatus = '{{ route('admin.promotion.change_status') }}';
