...
@section('content')
    <div class="row" id="object-category">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body ">
                    ...
                    <div id="datatable">
                        @include('Admin.Customer.datatable', [
        ...
        @include('Admin.Customer.create-model')
    </div>
@endsection
@section('script')
    <script>
        var apiGetList = '{{ route('admin.customer.get_list') }}';
        var apiCreate = '{{ route('admin.customer.create') }}';
        var apiGetItem = '{{ route('admin.customer.get_customer') }}';
        var apiChangeStatus = '{{ route('admin.customer.change_status') }}';
