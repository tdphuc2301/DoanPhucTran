...
@section('script')
    <script>
        var apiGetList = '{{ route('admin.brand.get_list') }}';
        var apiCreate = '{{ route('admin.brand.create') }}';
        var apiGetItem = '{{ route('admin.brand.get_category') }}';
        var apiChangeStatus = '{{ route('admin.brand.change_status') }}';
