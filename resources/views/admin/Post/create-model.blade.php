                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <div class="row" id="create-data-form">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <p class="m-0 font-0-9">Tiêu đề bài viết<span class="text-danger">*</span>
                                        </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="short-content" rows="7" class="short-content form-control form-control-sm"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <p class="text-center ">Ảnh đại diện <span><a class="remove-image"
                                                    style="display:none" href="#">(Xóa)</a></span></p>
                                        <div class="avatar-wrapper">
                                            <img class="profile-pic" image-type="image"
