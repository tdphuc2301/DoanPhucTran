                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <div class="row" id="create-data-form">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <p class="m-0 font-0-9">Tên bộ nhớ tạm<span class="text-danger">*</span>
                                        </p>
                                        <input name="name" placeholder="Tên danh mục" required type="text"
                                            class="form-control form-control-sm">
                                    </div>
                                    <div class="form-group">
                                        <p class="m-0 font-0-9">Sức chứa<span class="text-danger">*</span>
                                        </p>
                                        <input name="capacity" placeholder="Đường dẫn" required type="number"
                                               class="form-control form-control-sm">
                                    </div>
                                    <div class="form-group">
