                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <div class="row" id="create-data-form">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <p class="m-0 font-0-9">Tên màu<span class="text-danger">*</span>
                                        </p>
                                    ...
                                    <div class="form-group">
                                        <div class="unit">
                                            ...
                                            <input type="color" readonly id="color" name="color" onchange="colorValue(this.value)" value="{{$data->color_code ?? ''}}">
                                        </div>
                                        <input  id="hex_code" name="color_code" class="form-control form-control-sm" readonly value="{{$data->color_code ?? ''}}">
                                    </div>
